...
struct Textures
{
	Textures() 
	{
		...
		resourcesIcon[0].loadFromFile("texture/woodIcon.png");
		resourcesIcon[1].loadFromFile("texture/stoneIcon.png");
		resourcesIcon[2].loadFromFile("texture/goldIcon.png");
		resourcesIcon[3].loadFromFile("texture/gemIcon.png");
	}
	sf::Texture wall[16];
	sf::Texture grass;
	sf::Texture shop;
